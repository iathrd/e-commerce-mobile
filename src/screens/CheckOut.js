        ...
        <Card style={{borderRadius: 12}}>
          <View
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('ChangeAdress')}>
        ...
        <View style={{display: 'flex', flexDirection: 'column', marginTop: 50}}>
          ...
          <View
            ...
            <View
              ...
              />
              <Text style={{fontSize: 18, marginLeft: 10, flexGrow: 1}}>
                Mastercard
              </Text>
              <CheckBox
                style={{marginRight: 10, borderColor: 'grey', borderRadius: 4}}
                checked={false}
                color="#3CAEA4"
              />
            </View>
      ...
      <Footer style={{height: 200}}>
        <FooterTab
          ...
          <View style={{height: 60}}>
            <Button
              style={{backgroundColor: '#3CAEA4', borderRadius: 35}}
